...
atproto: 'at://did:plc:e24okfpxr7ctcbmruijop5gp/site.standard.document/3mv2od42t5j2a'
article_number:
volume: 2
issue: 2
pages: 2-7
...
9.  If we return to the metaphysics of determinacy espoused by Dante, Montaigne, Descartes, and Browne, we begin and end with epistemological uncertainties, with the prospect, perhaps hope, of a better science or a more reconciling belief-system always in the future, directing the mode of inquiry toward accuracy. The duality that arises within the difficulties of knowledge also makes visible a metaphysical problem; that is, the problem of making visible by analogy, a problem of the problem, as it were. Knowledge, therefore, as a "function" rather than a "form" or a "force" recasts the aim of religious theory and all disciplines toward the "No" that concerns it, the chaos it attempts to territorialize. And, as Deleuze writes, "it is here that concepts, sensations, and functions become indiscernible, as if they shared the same shadow that extends itself across their different nature and accompanies them."[^26] Indiscernible not uncertain; coordinated not referential; repeated not continued.

### Notes

[^1]: "There is yet another meaning of desiring theology. This is the understanding that theology written in the wake of psychoanalysis and its intellectual entailments must elaborate the meaning and importance of desire in its own discourse" Charles E. Winquist, _Desiring Theology_ (Chicago: The University of Chicago Press, 1995), x.

[^2]: Seventeenth century British physician and philosopher best known for his text _Religio Medici_.

[^3]: Gilles Deleuze, _Difference and Repetition_, Paul Patton, trans. (New York: Columbia University Press, 1994), 41.

[^4]: Deleuze, _Difference and Repetition_, 35-37.

[^5]: Immanuel Kant,_Critique of Pure Reason_, Norman Kemp Smith, trans. (New York: St. Martin's Press, 1965), 501.

[^6]: See Carl Raschke, "Para/Theology: The Study of Religion and the Science of the Negative," in _The Journal of Cultural and Religious Theory_, Vol. 2 (2000), no.1: <[https://jcrt.org/archives/02.1/raschke.shtml](https://jcrt.org/archives/02.1/index.html?page=raschke.shtml)>.

[^7]: Gilles Deleuze, _The Logic of Sense_, Mark Lester and Charles Stivale, trans. (New York: Columbia University Press, 1990), 179.

[^8]: Deleuze, _Difference and Repetition_, 303.

[^9]: Alain Badiou, _Deleuze: The Clamour of Being_, Louise Burchill, trans. (Minneapolis: University of Minnesota Press, 2000), 31-32.

[^10]: See Badiou, 3.

[^11]: Gilles Deleuze and Félix Guattari, _What is Philosophy?_ Hugh Tomlinson and Graham Burchell, trans. (New York: Columbia University Press, 1994), 215.

[^12]: Deleuze and Guattari, 215.

[^13]: Deleuze and Guattari, 217.

[^14]: Deleuze and Guattari, 216.

[^15]: Deleuze and Guattari, 217.

[^16]: Deleuze and Guattari, 218.

[^17]: Paul Klee writes, in _On Modern Art_, that "[n]obody will expect a tree to form its crown in exactly the same way as its root. Between above and below there cannot be exact mirror images of each other. It is obvious that different functions operating in different elements must produce vital divergences" (Paul Findlay, trans. [London: Faber and Faber, 1948], 59).

[^18]: Manuel DeLanda, "Immanence and Transcendence in the Genesis of Form," in _A Deleuzean Century?_ (Durham and London: Duke University Press, 1999), 120.

[^19]: In _Bergsonism_, Deleuze refers to going beyond the "turn in experience" in which "conditions of experience are less determined in concepts than in pure concepts." He goes on to note that after moving "beyond the turn" the lines (of divergence) intersect at a "virtual point," leaving, for Bergson, the philosophical process as an "infinitesimal calculus" (Hugh Tomlinson and Barbara Habberjam, trans. [New York: Zone Books, 1988], 28, 27).

[^20]: Deleuze and Guattari, 218.

[^21]: Klee.

[^22]: Deleuze and Guattari, 218.

[^23]: Deleuze and Guattari, 218.

[^24]: DeLanda, 119-134.

[^25]: Victor E. Taylor, _Para/Inquiry: Postmodern Religion and Culture_ (New York and London: Routledge, 2000).

[^26]: Deleuze and Guattari, 218.
